...
class VotesViewSet(ViewSet):
    serializer_votelist_class = ListVoteSerializer
    serializer_submitvote_class = CreateVoteSerializer
    ...
    def list(self, request):
        ...
        serializer = self.serializer_votelist_class(qs, many=True)
    ...
    def post(self, request, format=None):
        ...
        if data_not_found or candidate not in election.candidate_set.all():
        ...
        serializer = self.serializer_submitvote_class(
            data={
